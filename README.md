...
- **Document upload**: This functionality enables users to upload documents directly into TutorAI. The application will integrate these documents seamlessly, allowing for an interactive and integrated learning experience. The document upload feature support a wide range of file formats, including PDF, DOC, DOCX, PNG, JPG, JPEG, PPM, TIFF, BMP and more. For example, a user can upload one or more PDF files containing the course material, and TutorAI will process the content and be able to use it.
- **Information search**: Empower your learning with the ability to conduct in-depth searches within uploaded Documents. Whether it's a quick fact verification or a deep dive into complex topics, TutorAI makes comprehensive information access simple and efficient.
...
- **Quiz and test generation**: Automatic generation of quizzes and tests based on the material in the documents
